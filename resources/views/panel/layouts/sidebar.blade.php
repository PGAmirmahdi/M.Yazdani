...
<div class="navigation">
    <div class="navigation-icon-menu" style="overflow-y: auto">
        <ul>
            ...
            @canany(['customers-list','foreign-customers-list','sms-list'])
                <li class="{{ active_sidebar(['customers','customers/create','customers/{customer}/edit','search/customers','foreign-customers','foreign-customers/create','foreign-customers/{foreign_customer}/edit','search/foreign-customers','sms','sms/create','sms/{sms}/edit','sms.search','sms/{sms}/show','calls','calls/create','calls/{call}/edit','calls/{call}/show','calls/search','whatsapp','whatsapp/create','whatsapp/createGroup','whatsapp/{whatsapp}']) ? 'active' : '' }}"
    ...
    <div class="navigation-menu-body">
        ...
        <ul id="navigationCustomers"
            class="{{ active_sidebar(['customers','customers/create','customers/{customer}/edit','search/customers','foreign-customers','foreign-customers/create','foreign-customers/{foreign_customer}/edit','search/foreign-customers','sms','sms/create','sms/{sms}/edit','sms.search','sms/{sms}/show','calls','calls/create','calls/{call}/edit','calls/{call}/show','calls/{call}/search','whatsapp','whatsapp/create','whatsapp/createGroup','whatsapp/{whatsapp}']) ? 'navigation-active' : '' }}">
